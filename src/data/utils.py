...
def get_chkpnt(path_to_chkpnt_dir, name=''):
    '''Get the latest checkpoint and scraping statistics at that last checkpoint
    to allow a seamless resume
    
    Keyword arguments:
    path_to_chkpnt_dir -- template for path to the checkpoints directory ( default: '' )
    name -- name of the checkpoints directory to focus on ( default: '' )
    '''
